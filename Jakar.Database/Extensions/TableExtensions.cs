...
public static class TableExtensions
{
    ...
    {
        return reader.GetFieldValue<object?>( nameof(JsonModels.IJsonModel.AdditionalData) ) is string value
    ...
    public static TValue? GetData<TValue>( this DbDataReader reader, string propertyName )
        where TValue : class
    {
        return reader.GetFieldValue<object?>( propertyName ) is string json
    ...
    {
        return reader.GetFieldValue<object?>( propertyName ) is TValue value
                   ? value
                   : default;
    }
