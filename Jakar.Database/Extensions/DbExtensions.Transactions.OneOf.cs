...
{
    public static async IAsyncEnumerable<OneOf<TResult, Error>> TryCall<TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, CancellationToken, IAsyncEnumerable<OneOf<TResult, Error>>> func, [EnumeratorCancellation] CancellationToken token = default )
    {
    ...
    public static async IAsyncEnumerable<OneOf<TResult, Error>> TryCall<TArg1, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, CancellationToken, IAsyncEnumerable<OneOf<TResult, Error>>> func, TArg1 arg1, [EnumeratorCancellation] CancellationToken token )
    {
        await using DbConnection                connection  = await db.ConnectAsync( token );
        await using DbTransaction               transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async IAsyncEnumerable<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, CancellationToken, IAsyncEnumerable<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, [EnumeratorCancellation] CancellationToken token )
    {
        await using DbConnection                connection  = await db.ConnectAsync( token );
        await using DbTransaction               transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async IAsyncEnumerable<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TArg3, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, TArg3, CancellationToken, IAsyncEnumerable<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, TArg3 arg3, [EnumeratorCancellation] CancellationToken token )
    {
        await using DbConnection                connection  = await db.ConnectAsync( token );
        await using DbTransaction               transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async IAsyncEnumerable<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TArg3, TArg4, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, TArg3, TArg4, CancellationToken, IAsyncEnumerable<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, [EnumeratorCancellation] CancellationToken token )
    {
        await using DbConnection                connection  = await db.ConnectAsync( token );
        await using DbTransaction               transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async IAsyncEnumerable<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TArg3, TArg4, TArg5, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, TArg3, TArg4, TArg5, CancellationToken, IAsyncEnumerable<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, [EnumeratorCancellation] CancellationToken token )
    {
        await using DbConnection                connection  = await db.ConnectAsync( token );
        await using DbTransaction               transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async ValueTask<OneOf<TResult, Error>> TryCall<TArg1, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, CancellationToken, ValueTask<OneOf<TResult, Error>>> func, TArg1 arg1, CancellationToken token = default )
    {
        await using DbConnection  connection  = await db.ConnectAsync( token );
        await using DbTransaction transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async ValueTask<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, CancellationToken, ValueTask<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, CancellationToken token = default )
    {
        await using DbConnection  connection  = await db.ConnectAsync( token );
        await using DbTransaction transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async ValueTask<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TArg3, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, TArg3, CancellationToken, ValueTask<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, TArg3 arg3, CancellationToken token )
    {
        await using DbConnection  connection  = await db.ConnectAsync( token );
        await using DbTransaction transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async ValueTask<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TArg3, TArg4, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, TArg3, TArg4, CancellationToken, ValueTask<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, CancellationToken token )
    {
        await using DbConnection  connection  = await db.ConnectAsync( token );
        await using DbTransaction transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async ValueTask<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TArg3, TArg4, TArg5, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, TArg3, TArg4, TArg5, CancellationToken, ValueTask<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, CancellationToken token )
    {
        await using DbConnection  connection  = await db.ConnectAsync( token );
        await using DbTransaction transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async ValueTask<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, CancellationToken, ValueTask<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, TArg6 arg6, CancellationToken token )
    {
        await using DbConnection  connection  = await db.ConnectAsync( token );
        await using DbTransaction transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
    ...
    public static async ValueTask<OneOf<TResult, Error>> TryCall<TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, TResult>( this IConnectableDb db, Func<DbConnection, DbTransaction, TArg1, TArg2, TArg3, TArg4, TArg5, TArg6, TArg7, CancellationToken, ValueTask<OneOf<TResult, Error>>> func, TArg1 arg1, TArg2 arg2, TArg3 arg3, TArg4 arg4, TArg5 arg5, TArg6 arg6, TArg7 arg7, CancellationToken token )
    {
        await using DbConnection  connection  = await db.ConnectAsync( token );
        await using DbTransaction transaction = await connection.BeginTransactionAsync( IsolationLevel.ReadCommitted, token );
