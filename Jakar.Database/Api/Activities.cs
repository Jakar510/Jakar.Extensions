...
public static class Activities
{
    ...
    [MethodImpl( MethodImplOptions.AggressiveInlining )] public static Activity Start( ActivityKind kind = ActivityKind.Internal, ActivityContext parentContext = default, IEnumerable<KeyValuePair<string, object?>>? tags = null, IEnumerable<ActivityLink>? links = null, [CallerMemberName] string name = EMPTY ) => Start( DateTimeOffset.UtcNow, kind, parentContext, tags, links, name );


    [MethodImpl( MethodImplOptions.AggressiveInlining )]
    public static Activity Start( DateTimeOffset startTime, ActivityKind kind = ActivityKind.Internal, ActivityContext parentContext = default, IEnumerable<KeyValuePair<string, object?>>? tags = null, IEnumerable<ActivityLink>? links = null, [CallerMemberName] string name = EMPTY ) =>
    ...
    [MethodImpl( MethodImplOptions.AggressiveInlining )]
    public static Activity Create( ActivityKind kind = ActivityKind.Internal, ActivityIdFormat idFormat = ActivityIdFormat.W3C, ActivityContext parentContext = default, IEnumerable<KeyValuePair<string, object?>>? tags = null, IEnumerable<ActivityLink>? links = null, [CallerMemberName] string name = EMPTY ) =>
