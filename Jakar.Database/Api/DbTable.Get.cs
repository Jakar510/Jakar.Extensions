...
public partial class DbTable<TRecord>
{
    ...
    {
        SqlCommand sql = Cache.Exists( matchAll, parameters );
    ...
    {
        SqlCommand sql = Cache.Get( matchAll, parameters );
