...
public sealed class TelemetryActivitySource( AppContext appContext ) : IReadOnlyCollection<TelemetryActivity>, IDisposable
{
    ...
    public IEnumerator<TelemetryActivity> GetEnumerator() => Activities.GetEnumerator();
