...
public static class LayoutExtensions
{
    ...
    public static void RemovePopup( this UITableViewCell cell, UIView view ) => cell.InputView.Subviews.FirstOrDefault( item => item.Equals( view ) )
                                                                                   ?.RemoveFromSuperview();
    ...
    public static IEnumerable<NSLayoutConstraint> SetBounds( this UIView view, in UIView parent, in bool translate = false ) => view.SetBounds( parent.TopAnchor, parent.BottomAnchor, parent.LeftAnchor, parent.RightAnchor, translate );

    public static IEnumerable<NSLayoutConstraint> SetBounds( this UIView view, in NSLayoutYAxisAnchor top, in NSLayoutYAxisAnchor bottom, in NSLayoutXAxisAnchor left, in NSLayoutXAxisAnchor right, in bool translate = false )
    {
    ...
    public static NSLayoutConstraint WidthOf( this UIView view, in UIView other, in nfloat leftFactor, in nfloat rightFactor ) =>
        view.WidthOf( other,
                      Math.Abs( leftFactor - rightFactor )
                          .ToNFloat() );
    ...
    public static NSLayoutConstraint HeightOf( this UIView view, in UIView other, in nfloat topFactor, in nfloat bottomFactor ) =>
        view.HeightOf( other,
                       Math.Abs( topFactor - bottomFactor )
                           .ToNFloat() );
