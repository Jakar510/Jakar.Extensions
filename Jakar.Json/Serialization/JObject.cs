...
public ref struct JsonObject
{
    ...
    public readonly void Empty() => __writer.Append(START)
    ...
    private readonly JWriter Start( ReadOnlySpan<char> key ) => __writer.Indent()
                                                                        .Append(JWriter.QUOTE)
                                                                        .Append(key)
                                                                        .Append(JWriter.QUOTE)
                                                                        .Append(JWriter.COLON)
                                                                        .Append(JWriter.SPACE);
    ...
    public readonly JsonArray AddArray( ReadOnlySpan<char> key ) => Start(key)
       .AddArray();
    ...
    public readonly JsonObject AddObject( ReadOnlySpan<char> key ) => Start(key)
       .AddObject();
