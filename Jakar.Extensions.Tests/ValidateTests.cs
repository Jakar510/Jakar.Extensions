...
public class ValidateTests : Assert
{
    ...
    [ Test, TestCase( 0, false ), TestCase( 10, true ), TestCase( 8080, true ), TestCase( 65534, true ), TestCase( 655350, false ) ] public void Port( int s, bool expected ) => AreEqual( s.IsValidPort(), expected );
