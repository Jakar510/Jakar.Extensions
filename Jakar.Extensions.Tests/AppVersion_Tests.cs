...
public class AppVersion_Tests : Assert
{
    ...
    [ Test, TestCase( "1" ), TestCase( "1.0" ), TestCase( "1.2.3" ), TestCase( "1.2.3.4" ), TestCase( "1.2.3.4.5" ), TestCase( "1.2.3.4.5.6" ), TestCase( "0.7.0.25" ) ] public void Parse( string s ) => DoesNotThrow( () => AppVersion.Parse( s ) );
    ...
    [ Test, TestCase( "", false ), TestCase( "1" ), TestCase( "1.0" ), TestCase( "1.2.3" ), TestCase( "1.2.3.4" ), TestCase( "1.2.3.4.5" ), TestCase( "1.2.3.4.5.6" ), TestCase( "1.2.3.4.5.6.7", false ), TestCase( "1.0.0.0.0.0.0", false ),
      TestCase(       "1.0.0...0.0.0", false ), TestCase( "1.a1", false ), TestCase( "0.7.0.25" ) ]
    ...
    [ Test, TestCase( "", false ), TestCase( "1" ), TestCase( "1.0" ), TestCase( "1.2.3" ), TestCase( "1.2.3.4" ), TestCase( "1.2.3.4.5" ), TestCase( "1.2.3.4.5.6" ), TestCase( "1.2.3.4.5.6.7", false ), TestCase( "1.0.0.0.0.0.0", false ),
      TestCase(       "1.0.0...0.0.0", false ), TestCase( "0.7.0.25" ) ]
    ...
    [ Test, TestCase( "1",         AppVersion.Format.Singular ), TestCase(          "1.2",         AppVersion.Format.Minimal ), TestCase(  "1.2.3",         AppVersion.Format.Typical ), TestCase( "1.2.3.4", AppVersion.Format.Detailed ),
      TestCase(       "1.2.3.4.5", AppVersion.Format.DetailedRevisions ), TestCase( "1.2.3.4.5.6", AppVersion.Format.Complete ), TestCase( "1.2.3.4.5.6.7", null ), TestCase( "1.2.3..4.5.6", null ), TestCase( "1.2.3..4.5.6.7", null ) ]
    ...
    [ Test, TestCase( "20.12.1", "21.10.3",             false ), TestCase( "20.6.1", "21.10.3", false ), TestCase( "21.10.2", "21.10.3", false ), TestCase( "21.10.3", "21.10.3" ), TestCase( "21.10.4", "21.10.3" ), TestCase( "21.11.3", "21.10.3" ),
      TestCase(       "21.12.1", "21.10.3" ), TestCase( "22.10.3",         "21.10.3" ), TestCase( "22.12.1", "21.10.3" ) ]
    ...
    [ Test, TestCase( "20.6.1",  "21.10.3", false ), TestCase( "20.12.1", "21.10.3", false ), TestCase( "21.10.2", "21.10.3", false ), TestCase( "21.10.3", "21.10.3", false ), TestCase( "21.10.4", "21.10.3" ), TestCase( "21.11.3", "21.10.3" ),
      TestCase(       "21.12.1", "21.10.3" ), TestCase( "22.10.3", "21.10.3" ), TestCase( "22.12.1", "21.10.3" ) ]
    ...
    [ Test, TestCase( "20.6.1",  "21.10.3" ), TestCase( "20.12.1",         "21.10.3" ), TestCase( "21.10.2", "21.10.3" ), TestCase( "21.10.3", "21.10.3", false ), TestCase( "21.10.4", "21.10.3", false ), TestCase( "21.11.3", "21.10.3", false ),
      TestCase(       "21.12.1", "21.10.3",             false ), TestCase( "22.10.3",             "21.10.3", false ), TestCase(     "22.12.1", "21.10.3", false ) ]
    ...
    [ Test, TestCase( "20.6.1",  "21.10.3" ), TestCase( "20.12.1",         "21.10.3" ), TestCase( "21.10.2", "21.10.3" ), TestCase( "21.10.3", "21.10.3" ), TestCase( "21.10.4", "21.10.3", false ), TestCase( "21.11.3", "21.10.3", false ),
      TestCase(       "21.12.1", "21.10.3",             false ), TestCase( "22.10.3",             "21.10.3", false ), TestCase(     "22.12.1", "21.10.3",             false ) ]
    ...
    [ Test, TestCase( "21", "21.10.3" ), TestCase( "21.10", "21.10.3" ), TestCase( "21.10.0.0", "21.10.3" ), TestCase( "21.10.0.0", "21.10.3.0.0.0" ) ]
    ...
    [ Test, TestCase( "21.10.3", "20.6.1", false ), TestCase( "21.10.3", "20.12.1", false ), TestCase( "21.10.3", "21.10.02", false ), TestCase( "21.10.3", "21.10.2", false ), TestCase( "21.10.3", "21.10.3" ), TestCase( "21.10.3", "21.10.4" ),
      TestCase(       "21.10.3", "21.10.5" ), TestCase( "21.10.3", "21.10.10" ), TestCase( "21.10.3", "21.10.20" ), TestCase( "21.10.3", "21.11.3", false ), TestCase( "21.10.3", "21.12.1", false ), TestCase( "21.10.3", "22.10.3", false ),
      TestCase(       "21.10.3", "22.12.1", false ), TestCase( "21.10.3.1", "21.10.2.1", false ), TestCase( "21.10.3.1", "21.10.3.1" ), TestCase( "21.10.3.1", "21.10.3.2" ), TestCase( "21.10.3.1", "21.10.4.1" ), TestCase( "21.10.3.1", "21.10.5.1" ),
      TestCase(       "21.10.3.1", "21.10.10.1" ), TestCase( "21.10.3.1", "21.10.20.1" ), TestCase( "21.10.3.1", "21.11.3.1", false ), TestCase( "21.10.3.1", "21.12.1.1", false ), TestCase( "21.10.3.1", "22.10.3.1", false ),
      TestCase(       "21.10.3.1", "22.12.1.1", false ), TestCase( "21.10.3.5.1", "21.10.2.5.1", false ), TestCase( "21.10.3.5.1", "21.10.3.5.1" ), TestCase( "21.10.3.5.1", "21.10.3.5.2" ), TestCase( "21.10.3.5.1", "21.10.4.5.1" ),
      TestCase(       "21.10.3.5.1", "21.10.5.5.1" ), TestCase( "21.10.3.5.1", "21.10.10.5.1" ), TestCase( "21.10.3.5.1", "21.10.20.5.1" ), TestCase( "21.10.3.5.1", "21.11.3.5.1", false ), TestCase( "21.10.3.5.1", "21.12.1.5.1", false ),
      TestCase(       "21.10.3.5.1", "22.10.3.5.1", false ), TestCase( "21.10.3.5.1", "22.12.1.5.1", false ) ]
    public void FuzzyEquals_Test( string left, string right, bool expected = true ) => AreEqual( expected, AppVersion.Parse( left ).FuzzyEquals( AppVersion.Parse( right ) ) );
}
