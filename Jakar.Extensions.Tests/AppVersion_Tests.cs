...
public class AppVersion_Tests : Assert
{
    ...
    [Test][TestCase( "1", AppVersionFormat.Singular )][TestCase( "1.2", AppVersionFormat.Minimal )][TestCase( "1.2.3", AppVersionFormat.Typical )][TestCase( "1.2.3.4", AppVersionFormat.Detailed )][TestCase( "1.2.3.4.5", AppVersionFormat.DetailedRevisions )][TestCase( "1.2.3.4.5.6", AppVersionFormat.Complete )][TestCase( "1.2.3.4.5.6.7", null )][TestCase( "1.2.3..4.5.6", null )][TestCase( "1.2.3..4.5.6.7", null )]
