...
{
    [Test][TestCase(typeof(string),     false )][TestCase( typeof(string[]), true )][TestCase( typeof(Dictionary<string, object>), true )][TestCase( typeof(Dictionary<string, string>), true )][TestCase( typeof(ConcurrentBag<string>), true )][TestCase( typeof(ObservableCollection<string>), true )][TestCase( typeof(List<string>), true )][TestCase( typeof(List<List<string>>), true )][TestCase(      typeof(List<Guid>), true )]
