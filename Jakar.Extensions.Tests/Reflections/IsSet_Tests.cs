...
{
    [Test, TestCase( typeof(string),          false ), TestCase( typeof(string[]), false ), TestCase( typeof(Dictionary<string, object>), false ), TestCase( typeof(Dictionary<string, string>), false ), TestCase( typeof(ConcurrentBag<string>), false ), TestCase( typeof(ObservableCollection<string>), false ), TestCase( typeof(HashSet<string>), true ), TestCase( typeof(HashSet<int>), true ),
