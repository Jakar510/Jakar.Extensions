...
public class IsDictionary_Tests : Assert
{
    ...
    [Test, TestCase( typeof(string),                         null ), TestCase(              typeof(Dictionary<string, object>), typeof(object) ), TestCase( typeof(Dictionary<string, string>), typeof(string) ), TestCase( typeof(Dictionary<string, int>), typeof(int) ), TestCase( typeof(Dictionary<string, int?>), typeof(int?) ), TestCase( typeof(Dictionary<string, List<int>>), typeof(List<int>) ),
     TestCase(       typeof(Dictionary<string, List<int>?>), typeof(List<int>) ), TestCase( typeof(MultiDict),                  typeof(object) ), TestCase( typeof(ObservableDictionary<string, string>), typeof(string) ), TestCase( typeof(List<string>), null ), TestCase( typeof(List<Guid>), null )]
