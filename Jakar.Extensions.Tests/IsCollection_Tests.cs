...
public class IsCollection_Tests : Assert
{
    ...
    [ Test, TestCase( typeof(string),          null ), TestCase( typeof(Dictionary<string, object>), typeof(string) ), TestCase( typeof(Dictionary<string, string>), typeof(string) ), TestCase( typeof(ConcurrentBag<string>), typeof(string) ),
      TestCase(       typeof(HashSet<string>), typeof(string) ), TestCase( typeof(List<string>), typeof(string) ), TestCase( typeof(List<List<string>>), typeof(List<string>) ), TestCase( typeof(List<Guid>), typeof(Guid) ) ]
