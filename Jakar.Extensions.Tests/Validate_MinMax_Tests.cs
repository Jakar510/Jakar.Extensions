...
{
    [Test] public void TestMin_Integers()
    {
        int  left   = 5;
        int  right  = 3;
    ...
    [Test] public void TestMin_NullableIntegers()
    {
        int? left   = 5;
        int? right  = 3;
    ...
    [Test] public void TestMax_Integers()
    {
        int     left   = 5;
        int     right  = 3;
    ...
    [Test] public void TestMax_NullableIntegers()
    {
        int? left   = 5;
        int? right  = 3;
    ...
    [Test] public void TestMin_Doubles()
    {
        double  left   = 5.0;
        double  right  = 3.0;
    ...
    [Test] public void TestMin_NullableDoubles()
    {
        double? left   = 5.0;
        double? right  = 3.0;
    ...
    [Test] public void TestMax_Doubles()
    {
        double  left   = 5.0;
        double  right  = 3.0;
        double? result = Validate.Max<double>(left, right);
    ...
    [Test] public void TestMax_NullableDoubles()
    {
        double? left   = 5.0;
        double? right  = 3.0;
    ...
    [Test] public void TestMin_TimeSpans()
    {
    ...
    [Test] public void TestMax_TimeSpans()
    {
        TimeSpan  left   = TimeSpan.FromSeconds(5);
        TimeSpan  right  = TimeSpan.FromSeconds(3);
