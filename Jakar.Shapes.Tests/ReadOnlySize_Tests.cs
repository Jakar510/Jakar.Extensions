...
[TestFixture]
[TestOf(typeof(ReadOnlySize))]
public sealed class ReadOnlySize_Tests : Assert
{
    [Test] public void Zero_ShouldBeEmptyAndValid()
    {
        ReadOnlySize point = ReadOnlySize.Zero;
    ...
    {
        ReadOnlySize point = ReadOnlySize.Invalid;
    ...
    [Test] public void ImplicitConversion_ToSize_ShouldRoundValues()
    {
    ...
    [Test] public void IsEmpty_WhenWidthOrHeightIsNotZero_ShouldBeFalse()
    {
        ReadOnlySize point = new(1, 0);
        this.IsFalse(point.IsZero());

        point = new ReadOnlySize(0, 1);
        this.IsFalse(point.IsZero());
    }
    ...
    [Test] public void Operator_AddSizeF_ShouldAddCoordinates()
    {
        ReadOnlySizeF a      = new(1.5f, 2.5f);
    ...
    [Test] public void Operator_SubtractSizeF_ShouldSubtractCoordinates()
    {
    ...
    [Test] public void Operator_MultiplySizeF_ShouldMultiplyCoordinates()
    {
    ...
    [Test] public void Operator_DivideSizeF_ShouldDivideCoordinates()
    {
    ...
    [Test] public void Operator_AddDrawingSizeF_ShouldAddCoordinates()
    {
        ReadOnlySizeF a      = new(1.5f, 2.5f);
        SizeF         b      = new(2f, 3f);
        ReadOnlySizeF result = a + b;
    ...
    [Test] public void Operator_SubtractDrawingSizeF_ShouldSubtractCoordinates()
    {
        ReadOnlySizeF a      = new(5.5f, 6.5f);
        SizeF         b      = new(2f, 3f);
        ReadOnlySizeF result = a - b;
    ...
    [Test] public void Operator_MultiplyDrawingSizeF_ShouldMultiplyCoordinates()
    {
        ReadOnlySizeF a      = new(2f, 3f);
        SizeF         b      = new(4f, 5f);
        ReadOnlySizeF result = a * b;
    ...
    [Test] public void Operator_DivideDrawingSizeF_ShouldDivideCoordinates()
    {
        ReadOnlySizeF a      = new(8f, 9f);
        SizeF         b      = new(2f, 3f);
        ReadOnlySizeF result = a / b;
    ...
    [Test] public void Operator_AddDrawingSize_ShouldAddCoordinates()
    {
        ReadOnlySizeF a      = new(1.5f, 2.5f);
        Size          b      = new(2, 3);
        ReadOnlySizeF result = a + b;
    ...
    [Test] public void Operator_SubtractDrawingSize_ShouldSubtractCoordinates()
    {
        ReadOnlySizeF a      = new(5.5f, 6.5f);
        Size          b      = new(2, 3);
        ReadOnlySizeF result = a - b;
    ...
    [Test] public void Operator_MultiplyDrawingSize_ShouldMultiplyCoordinates()
    {
        ReadOnlySizeF a      = new(2f, 3f);
        Size          b      = new(4, 5);
        ReadOnlySizeF result = a * b;
    ...
    [Test] public void Operator_DivideDrawingSize_ShouldDivideCoordinates()
    {
        ReadOnlySizeF a      = new(8f, 9f);
        Size          b      = new(2, 3);
        ReadOnlySizeF result = a / b;
