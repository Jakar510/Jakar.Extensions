...
public static partial class Validate
{
    ...
    {
        private const           RegexOptions OPTIONS  = RegexOptions.Compiled | RegexOptions.ExplicitCapture | RegexOptions.IgnoreCase | RegexOptions.Singleline;
        ...
        ///     </para>
        /// </summary>
        public static Regex Url => _url ??= new Regex( @"^(ht|f)tp(s?)\:\/\/[0-9a-zA-Z]([-.\w]*[0-9a-zA-Z])*(:(0-9)*)*(\/?)([a-zA-Z0-9\-\.\?\,\'\/\\\+&%\$#_]*)?$", OPTIONS, _timeout );
        ...
        public static class PhoneNumbers
        {
            ...
            ///     </para>
            /// </summary>
            public static Regex Generic => _generic ??= new Regex( @"\+(9[976]\d|8[987530]\d|6[987]\d|5[90]\d|42\d|3[875]\d|2[98654321]\d|9[8543210]|8[6421]|6[6543210]|5[87654321]|4[987654310]|3[9643210]|2[70]|7|1)\d{1,14}$", OPTIONS, _timeout );
            ...
            ///     </para>
            /// </summary>
            public static Regex IndiaNew => _indiaNew ??= new Regex( @"((\+*)((0[ -]+)*|(91 )*)(\d{12}+|\d{10}+))|\d{5}([- ]*)\d{6}", OPTIONS, _timeout );
            ...
            ///     </para>
            /// </summary>
            public static Regex IndiaOld => _indiaOld ??= new Regex( @"((\+*)(0*|(0 )*|(0-)*|(91 )*)(\d{12}+|\d{10}+))|\d{5}([- ]*)\d{6}", OPTIONS, _timeout );
