...
public struct MutableSize( double width, double height ) : ISize<MutableSize>
{
    ...
    public static readonly MutableSize Two           = 2;
    public static readonly MutableSize Three         = 3;
    public static readonly MutableSize Four          = 4;
    public static readonly MutableSize Five          = 5;
    public static readonly MutableSize Six           = 6;
    public static readonly MutableSize Seven         = 7;
    public static readonly MutableSize Eight         = 8;
    public static readonly MutableSize Nine          = 9;
    public static readonly MutableSize Ten           = 10;
    public static readonly MutableSize NegativeOne   = -1;
    public static readonly MutableSize NegativeTwo   = -2;
    public static readonly MutableSize NegativeThree = -3;
    public static readonly MutableSize NegativeFour  = -4;
    public static readonly MutableSize NegativeFive  = -5;
    public static readonly MutableSize NegativeSix   = -6;
    public static readonly MutableSize NegativeSeven = -7;
    public static readonly MutableSize NegativeEight = -8;
    public static readonly MutableSize NegativeNine  = -9;
    public static readonly MutableSize NegativeTen   = -10;
