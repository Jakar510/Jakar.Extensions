...
public readonly struct ReadOnlyRectangle( double x, double y, double width, double height ) : IRectangle<ReadOnlyRectangle, ReadOnlySize, ReadOnlyPoint, ReadOnlyThickness, double>, IMathOperators<ReadOnlyRectangle>
{
    ...
    static        ReadOnlyRectangle IGenericShape<ReadOnlyRectangle>.Zero    => Zero;
    ...
    public static implicit operator ReadOnlyRectangle( Rectangle  rectangle ) => new(rectangle.X, rectangle.Y, rectangle.Width, rectangle.Height);
    public static implicit operator ReadOnlyRectangle( RectangleF rectangle ) => new(rectangle.X, rectangle.Y, rectangle.Width, rectangle.Height);
    public static implicit operator ReadOnlyRectangle( RectangleD rectangle ) => new(rectangle.X, rectangle.Y, rectangle.Width, rectangle.Height);
