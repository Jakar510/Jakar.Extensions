...
public struct RectangleD( double x, double y, double width, double height ) : IMutableRectangle<RectangleD>
{
    ...
    static ref readonly          RectangleD IShape<RectangleD>.Zero    => ref Zero;
    static ref readonly          RectangleD IShape<RectangleD>.Invalid => ref Invalid;
    ...
    public static implicit operator ReadOnlyRectangle( RectangleD  rect )      => new(rect.X, rect.Y, rect.Width, rect.Height);
    ...
    [Pure]
    public static RectangleD Create<T>( ref readonly T rect )
        where T : IRectangle<T>
    {
        return new RectangleD(rect.X, rect.Y, rect.Width, rect.Height);
    }
    [Pure] public static RectangleD Create( double            x,         double               y,   in ReadOnlySize size )                 => new(x, y, size.Width, size.Height);
    ...
    [Pure] public static RectangleD Create( in ReadOnlyPoint  topLeft,   in ReadOnlyPoint     bottomRight ) => new(topLeft.X, topLeft.Y, bottomRight.X - topLeft.X, bottomRight.Y - topLeft.Y);
    [Pure] public static RectangleD Create( in ReadOnlyPointF topLeft,   in ReadOnlyPointF    bottomRight ) => new(topLeft.X, topLeft.Y, bottomRight.X - topLeft.X, bottomRight.Y - topLeft.Y);
    [Pure] public static RectangleD Create( in RectangleD     rectangle, in ReadOnlyThickness padding )     => rectangle + padding;
    ...
    public readonly int CompareTo( RectangleD other )
    {
    ...
    public readonly bool   Equals( RectangleD other )                                  => X.Equals(other.X)     && Y.Equals(other.Y) && Width.Equals(other.Width) && Height.Equals(other.Height);
    public override bool   Equals( object?    other )                                  => other is RectangleD x && Equals(x);
    public override int    GetHashCode()                                               => HashCode.Combine(X, Y, Width, Height);
    public override string ToString()                                                  => ToString(null, null);
    public readonly string ToString( string? format, IFormatProvider? formatProvider ) => IRectangle<RectangleD>.ToString(this, format);
    ...
    public static bool ContainsAny<T>( ref readonly T rect, params ReadOnlySpan<ReadOnlyPoint> others )
        where T : IRectangle<T>
    {
        RectangleD rectangle = Create(in rect);
    ...
    [Pure] public readonly bool Contains( in       RectangleD other ) => Left <= other.Left && Right >= other.Right && Top <= other.Top && Bottom >= other.Bottom;
    [Pure] public readonly bool IntersectsWith( in RectangleD other ) => ( Left >= other.Right || Right <= other.Left || Top >= other.Bottom || Bottom <= other.Top ) is false;
    ...
    [Pure]
    public RectangleD Union( in RectangleD other )
    {
    ...
    public static        RectangleD operator *( RectangleD rectangle, ReadOnlyPointF                   other )  => new(rectangle.X * other.X, rectangle.Y * other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator /( RectangleD rectangle, ReadOnlyPointF                   other )  => new(rectangle.X / other.X, rectangle.Y / other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator +( RectangleD rectangle, PointF                           other )  => new(rectangle.X + other.X, rectangle.Y + other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator -( RectangleD rectangle, PointF                           other )  => new(rectangle.X - other.X, rectangle.Y - other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator *( RectangleD rectangle, PointF                           other )  => new(rectangle.X * other.X, rectangle.Y * other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator /( RectangleD rectangle, PointF                           other )  => new(rectangle.X / other.X, rectangle.Y / other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator +( RectangleD rectangle, Point                            other )  => new(rectangle.X + other.X, rectangle.Y + other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator -( RectangleD rectangle, Point                            other )  => new(rectangle.X - other.X, rectangle.Y - other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator *( RectangleD rectangle, Point                            other )  => new(rectangle.X * other.X, rectangle.Y * other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator /( RectangleD rectangle, Point                            other )  => new(rectangle.X / other.X, rectangle.Y / other.Y, rectangle.Width, rectangle.Height);
    ...
    public static        RectangleD operator &( RectangleD rectangle, PointF                           other )  => new(other.X, other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator &( RectangleD rectangle, Point                            other )  => new(other.X, other.Y, rectangle.Width, rectangle.Height);
    public static        RectangleD operator &( RectangleD rectangle, ReadOnlySize                     other )  => new(rectangle.X, rectangle.Y, other.Width, other.Height);
    public static        RectangleD operator &( RectangleD rectangle, ReadOnlySizeF                    other )  => new(rectangle.X, rectangle.Y, other.Width, other.Height);
    public static        RectangleD operator &( RectangleD rectangle, Size                             other )  => new(rectangle.X, rectangle.Y, other.Width, other.Height);
    public static        RectangleD operator &( RectangleD rectangle, SizeF                            other )  => new(rectangle.X, rectangle.Y, other.Width, other.Height);
