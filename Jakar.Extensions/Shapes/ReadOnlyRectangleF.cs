...
public readonly struct ReadOnlyRectangleF( float x, float y, float width, float height ) : IRectangle<ReadOnlyRectangleF>
{
    ...
    static ref readonly ReadOnlyRectangleF IShape<ReadOnlyRectangleF>.Two     => ref Two;
    static ref readonly ReadOnlyRectangleF IShape<ReadOnlyRectangleF>.Three   => ref Three;
    static ref readonly ReadOnlyRectangleF IShape<ReadOnlyRectangleF>.Four    => ref Four;
    static ref readonly ReadOnlyRectangleF IShape<ReadOnlyRectangleF>.Five    => ref Five;
    static ref readonly ReadOnlyRectangleF IShape<ReadOnlyRectangleF>.Six     => ref Six;
    static ref readonly ReadOnlyRectangleF IShape<ReadOnlyRectangleF>.Seven   => ref Seven;
    static ref readonly ReadOnlyRectangleF IShape<ReadOnlyRectangleF>.Eight   => ref Eight;
    static ref readonly ReadOnlyRectangleF IShape<ReadOnlyRectangleF>.Nine    => ref Nine;
    static ref readonly ReadOnlyRectangleF IShape<ReadOnlyRectangleF>.Ten     => ref Ten;
