...
{
    private readonly IMemoryOwner<TValue> __owner = owner;
    ...
    public          void                            Dispose()       => __owner.Dispose();
    ...
    [Pure] public static ParamsArray<TValue> Create( params ReadOnlySpan<TValue> args )
    {
    ...
    [Pure] public static ParamsArray<TValue> Create( List<TValue> args )
    {
