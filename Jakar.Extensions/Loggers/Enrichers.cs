...
public static class Enricher
{
    ...
    public static LogEventProperty GetProperty( in AppInfo          info ) => new(nameof(AppInfo), new StructureValue([GetProperty(info.Version, nameof(AppInfo.Version)), GetProperty(info.AppID,           nameof(AppInfo.AppID)), GetProperty(info.AppName,                                 nameof(AppInfo.AppName)), GetProperty(info.PackageName,                            nameof(AppInfo.PackageName))]));
