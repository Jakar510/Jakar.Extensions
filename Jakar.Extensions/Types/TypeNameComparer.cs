...
public sealed class TypeNameComparer : IComparer<Type>
{
    ...
    /// <summary>
    /// <para>
    /// Comparing by <see cref = "Type.AssemblyQualifiedName" /> would give the same result,
    /// but it performs a hidden concatenation (and therefore string allocation) of <see cref = "Type.FullName" /> and <see cref = "Type.Assembly" /> with its <see cref = "Assembly.FullName" />.
    /// </para>
