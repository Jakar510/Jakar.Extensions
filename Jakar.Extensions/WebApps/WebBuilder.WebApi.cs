...
public partial class WebBuilder
{
    ...
    /// </para>
    /// <para>
    /// To add services for controllers with views call <see cref="MvcServiceCollectionExtensions.AddControllersWithViews(IServiceCollection)"/>
    /// on the resulting builder.
    /// </para>
    /// <para>
    /// To add services for pages call <see cref="MvcServiceCollectionExtensions.AddRazorPages(IServiceCollection)"/>
    /// on the resulting builder.
    /// </para>
    /// </remarks>
    ...
    /// </para>
    /// <para>
    /// To add services for controllers for APIs call <see cref="MvcServiceCollectionExtensions.AddControllers(IServiceCollection)"/>.
    /// </para>
    /// <para>
    /// To add services for controllers with views call <see cref="MvcServiceCollectionExtensions.AddControllersWithViews(IServiceCollection)"/>.
    /// </para>
