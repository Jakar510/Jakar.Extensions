...
public static partial class Spans
{
    ...
    public static bool Contains<T>( this Span<T> span, in T value ) where T : unmanaged, IEquatable<T>
    {
    #if NET6_0
    ...
    public static bool Contains<T>( this ReadOnlySpan<T> span, in T value ) where T : unmanaged, IEquatable<T>
    {
    #if NET6_0
        return MemoryExtensions.Contains(span, value);
    #endif
    ...
    public static bool Contains<T>( this Span<T> span, in ReadOnlySpan<T> value ) where T : unmanaged, IEquatable<T>
    {
