...
public static partial class Spans
{
    ...
    [ Pure ]
    public static T Max<T>( this Span<T> value )
        where T : INumber<T>
    {
        T result = T.Zero;
        foreach ( T x in value ) { result = Max( result, x ); }
...
#else
    [ Pure ]
    public static double Max( this Span<double> value )
    {
        double result = 0;
    ...
    [ Pure ]
    public static float Max( this Span<float> value )
    {
        float result = 0;
    ...
    [ Pure ]
    public static long Max( this Span<long> value )
    {
        long result = 0;
    ...
    [ Pure ]
    public static ulong Max( this Span<ulong> value )
    {
        ulong result = 0;
    ...
    [ Pure ]
    public static int Max( this Span<int> value )
    {
        int result = 0;
    ...
    [ Pure ]
    public static uint Max( this Span<uint> value )
    {
        uint result = 0;
    ...
    [ Pure ]
    public static short Max( this Span<short> value )
    {
        short result = 0;
    ...
    [ Pure ]
    public static ushort Max( this Span<ushort> value )
    {
        ushort result = 0;
    ...
    [ Pure ]
    public static int Max<T>( this Span<T> value, Func<T, int> selector )
    {
        int result = 0;
    ...
    [ Pure ]
    public static uint Max<T>( this Span<T> value, Func<T, uint> selector )
    {
        uint result = 0;
        foreach ( T x in value ) { result = Math.Max( result, selector( x ) ); }
    ...
    [ Pure ]
    public static long Max<T>( this Span<T> value, Func<T, long> selector )
    {
        long result = 0;
        foreach ( T x in value ) { result = Math.Max( result, selector( x ) ); }
    ...
    [ Pure ]
    public static ulong Max<T>( this Span<T> value, Func<T, ulong> selector )
    {
        ulong result = 0;
        foreach ( T x in value ) { result = Math.Max( result, selector( x ) ); }
    ...
    [ Pure ]
    public static float Max<T>( this Span<T> value, Func<T, float> selector )
    {
        float result = 0;
        foreach ( T x in value ) { result = Math.Max( result, selector( x ) ); }
    ...
    [ Pure ]
    public static double Max<T>( this Span<T> value, Func<T, double> selector )
    {
        double result = 0;
        foreach ( T x in value ) { result = Math.Max( result, selector( x ) ); }
...
#if NET7_0_OR_GREATER
    [ Pure ]
    public static T Max<T>( this ReadOnlySpan<T> value )
        where T : INumber<T>
    {
        T result = T.Zero;
        foreach ( T x in value ) { result = Max( result, x ); }
