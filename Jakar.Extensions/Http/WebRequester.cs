...
public sealed partial class WebRequester( HttpClient client, IHostInfo host, Encoding encoding, ILogger? logger = null, RetryPolicy? retryPolicy = null ) : IDisposable
{
    ...
    [MethodImpl( MethodImplOptions.AggressiveInlining )] public static  WebRequester       Create<TClass>( IServiceProvider         provider,   RetryPolicy? retryPolicy )                                                                                    => Create<TClass>( GetHttpClientFactory( provider ), IHostInfo.Get( provider ), GetLogger( provider ), retryPolicy );
    ...
    [MethodImpl( MethodImplOptions.AggressiveInlining )] public static  WebRequester       Create( IServiceProvider                 provider,   RetryPolicy? retryPolicy )                                                                                    => Create( GetHttpClientFactory( provider ), IHostInfo.Get( provider ), GetLogger( provider ), retryPolicy );
    ...
    [MethodImpl( MethodImplOptions.AggressiveInlining )] private static ILogger            GetLogger( IServiceProvider              provider ) => provider.GetRequiredService<ILoggerFactory>().CreateLogger( nameof(WebRequester) );
    [MethodImpl( MethodImplOptions.AggressiveInlining )] private static IHttpClientFactory GetHttpClientFactory( IServiceProvider   provider ) => provider.GetRequiredService<IHttpClientFactory>();
