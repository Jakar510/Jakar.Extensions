...
public sealed class ServerProtocolViolationException : WebException
{
    ...
    public ServerProtocolViolationException( string message, WebException source, CancellationToken token ) : this(message,
    ...
    public ServerProtocolViolationException( string             message,
                                             Exception          inner,
