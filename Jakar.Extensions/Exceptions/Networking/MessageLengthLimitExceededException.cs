...
public sealed class MessageLengthLimitExceededException : WebException
{
    ...
    public MessageLengthLimitExceededException( string message, WebException source, CancellationToken token ) : this(message,
    ...
    public MessageLengthLimitExceededException( string             message,
                                                Exception          inner,
