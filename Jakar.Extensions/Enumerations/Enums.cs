...
public static partial class Enums
{
    ...
    public static TEnum  GetEnumValue<TEnum>( this         IReadOnlyDictionary<string, TEnum> dictionary, TEnum value ) where TEnum : Enum => dictionary.First( pair => pair.Key == value.ToString() ).Value;
