...
public static class MigrationExtensions
{
    ...
    /// </summary>
    public static bool CreateColumn_Enum( this ICreateTableColumnAsTypeSyntax col, in PropertyInfo propertyInfo, in Type propertyType )
    {
    ...
    /// <returns> </returns>
    public static bool CreateColumn_Reference( this ICreateTableColumnAsTypeSyntax col, in Type propertyType )
    {
    ...
    public static bool SetNullable<TNext, TNextFk>( this IColumnOptionSyntax<TNext, TNextFk> item, in PropertyInfo propInfo ) where TNext : IFluentSyntax
    ...
    public static void Throw( this Type classType, in PropertyInfo prop )
    {
    ...
    public static TNext? TryBuiltInValueTypes<TNext>( this IColumnTypeSyntax<TNext> col, in PropertyInfo propInfo, in Type propertyType ) where TNext : IFluentSyntax
    {
    ...
    public static bool TryHandleOtherTypes( this ICreateTableColumnAsTypeSyntax col, in PropertyInfo propInfo, in Type propertyType )
    {
    ...
    public static string GetMappingTableName( this Type parent, in PropertyInfo propertyInfo )
    {
    ...
    public static string GetMappingTableName<T>( this Type   parent, in string       propertyName, in IEnumerable<T> items ) => parent.GetMappingTableName(propertyName,      typeof(T));
    public static string GetMappingTableName( this    Type   parent, in PropertyInfo propertyInfo, in Type           other ) => parent.GetMappingTableName(propertyInfo.Name, other);
    public static string GetMappingTableName( this    Type   parent, in string       propertyName, in Type           other ) => parent.Name.GetMappingTableName(propertyName, other.Name);
    public static string GetMappingTableName( this    string parent, in string       propertyName, in string         other ) => $"{parent}_{other}_{propertyName}_mapping";
...
//											   in   PropertyInfo                   propInfo,
//											   in   Type                           propertyType
