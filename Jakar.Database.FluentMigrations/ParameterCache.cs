...
public static class PropertyCache
{
    ...
    public static IEnumerable<string> GetParamNames( this object o, in bool removeID )
    {
        ...
        return o.GetType().GetParamNames(removeID);
    }
    public static IEnumerable<string> GetParamNames( this Type type, in bool removeID ) => type.GetProperties(removeID).Select(x => x.Name);


    public static IEnumerable<PropertyInfo> GetProperties( this object o, bool removeID ) => o.GetType().GetProperties(removeID);
