...
public static partial class WebBuilder
{
    ...
    ///     <c> true </c>
    ///     to use startup error page; otherwise
    ///     <c> false </c>
    ///     .
    /// </param>
    /// <returns>
    ...
    ///     <c> true </c>
    ///     to prefer URLs configured on the
    ///     <see cref = "WebApplicationBuilder" />
    ///     ; otherwise
    ///     <c> false </c>
    ///     .
    ...
    ///     to configure.
    /// </param>
    /// <param name = "suppressStatusMessages" >
    ///     <c> true </c>
    ///     to suppress writing of hosting startup status messages; otherwise
    ///     <c> false </c>
    ///     .
    /// </param>
    /// <returns>
