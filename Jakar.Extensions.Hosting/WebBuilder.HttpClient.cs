...
{
    /// <summary>
    /// Adds the <see cref="IHttpClientFactory"/> and related builder to the <see cref="WebApplicationBuilder"/>.
    /// </summary>
    ...
    /// <summary>
    /// Adds the <see cref="IHttpClientFactory"/> and related builder to the <see cref="WebApplicationBuilder"/> and configures
