...
public partial class WebBuilder
{
    ...
    ///     that can be used to configure the client.
    /// </returns>
    /// <remarks>
    ///     <para>
    ///         <see cref = "HttpClient" />
    ...
    ///         as the name to configure the default client.
    ///     </para>
    /// </remarks>
    ...
    ///     <para>
    ///         <typeparamref name = "TClient" />
    ///         instances constructed with the appropriate
    ///         <see cref = "HttpClient" />
    ///         can be retrieved from
    ///         <see cref = "IServiceProvider.GetService(Type)" />
    ///         (and related methods) by providing
    ///         <typeparamref name = "TClient" />
    ///         as the service type.
    ///     </para>
    /// </remarks>
    ...
    ///     type and a named
    ///     <see cref = "HttpClient" />
    ///     . The client name will
    ///     be set to the type name of
    ///     <typeparamref name = "TClient" />
    ///     .
    /// </summary>
    /// <typeparam name = "TClient" >
    ...
    /// </param>
    /// <param name = "factory" >
    ///     A delegate that is used to create an instance of
    ///     <typeparamref name = "TClient" />
    ///     .
    /// </param>
    /// <returns>
