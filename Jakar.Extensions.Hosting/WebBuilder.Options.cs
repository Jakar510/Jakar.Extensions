...
public static partial class WebBuilder
{
    ...
    public static OptionsBuilder<TOptions> AddOptions<TOptions>( this WebApplicationBuilder builder, Action<TOptions> configure ) where TOptions : class =>
        builder.AddOptions<TOptions>()
               .Configure( configure );
    public static OptionsBuilder<TOptions> AddOptions<TOptions>( this WebApplicationBuilder builder, string name, Action<TOptions> configure ) where TOptions : class =>
        builder.AddOptions<TOptions>( name )
               .Configure( configure );
}
