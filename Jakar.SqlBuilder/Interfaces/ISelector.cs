...
public interface ISelector : IFromSyntax<ISqlBuilderRoot>, IAggregateFunctions<ISelector>
{
    ...
    /// <summary>
    /// Adds <param name="columnNames"></param> separated by <param name="separator"></param> to SELECT set and setting it to the <param name="alias"></param> variable
    /// </summary>
    /// <returns><see cref="ISelector"/></returns>
    ...
    /// Uses the <see cref="Type"/> of <typeparamref name="T"/> to get the table_name using <see cref="DapperTableExtensions.GetTableName(Type)"/>
    /// </para>
    /// Adds table_name.columnName separated by <param name="separator"></param> to SELECT set and setting it to the <param name="alias"></param> variable
    /// </summary>
    /// <returns><see cref="ISelector"/></returns>
