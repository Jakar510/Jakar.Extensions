...
public class Commands
{
    ...
    public ICommand LoadingCommand( Func<CancellationToken, Task> func, string?  title, string cancel, MaskType mask, Page page ) => new AsyncCommand(async () => await LoadingAsyncTask(func, title, cancel, mask, page).ConfigureAwait(false));
    ...
    public ICommand LoadingCommand( Func<Task> func, string?  title, string cancel, MaskType mask, Page page ) => new AsyncCommand(async () => await LoadingAsyncTask(func, title, cancel, mask, page).ConfigureAwait(false));
    ...
    public ICommand LoadingCommand( Action func, Page page, string? title,  string   cancel, MaskType mask ) => new AsyncCommand(async () => await LoadingAction(func, title, cancel, mask, page).ConfigureAwait(false));
