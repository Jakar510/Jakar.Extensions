...
/// <summary> For this implementation, a single Normal Enum and Themed Enum is needed. </summary>
                                                                                                  ...
                                                                                                  where TKey : Enum
{
    ...
    /// <summary> Default implementation uses <see cref="GetFullKey"/> . You may override this to use <see cref="GetShortKey"/> or which ever pattern you wish. </summary>
    ...
    /// <summary> <see cref="Color"/> is used in <see cref="BindAppTheme"/> </summary>
...
/// <summary> Recommended class to use for this implementation: <see cref="KeyNames"/> </summary>
public abstract class ResourceDictionaryManager : BaseResourceDictionaryManager
{
    ...
    /// <summary> Default implementation uses <see cref="GetFullKey{TThemedKey}"/> . You may override this to use <see cref="GetShortKey{TThemedKey}"/> or which ever pattern you wish. </summary>
    ...
    /// <summary> <see cref="Color"/> is used in <see cref="BindAppTheme{TValue, TThemedKey}"/> </summary>
    /// <typeparam name="TThemedKey"> </typeparam>
    /// <param name="bindable"> </param>
    /// <param name="property"> </param>
    /// <param name="key"> </param>
