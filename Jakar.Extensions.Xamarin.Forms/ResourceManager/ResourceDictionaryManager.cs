...
/// <summary>
///     Recommended class to use for this implementation:
///     <see cref = "KeyNames" />
/// </summary>
public abstract class ResourceDictionaryManager : BaseResourceDictionaryManager
{
    ...
    /// <summary>
    ///     Default implementation uses
    ///     <see cref = "GetFullKey{TThemedKey}" />
    ///     .
    ///     You may override this to use
    ///     <see cref = "GetShortKey{TThemedKey}" />
    ///     or which ever pattern you wish.
    /// </summary>
    ...
    ///     <see cref = "Color" />
    ///     is used in
    ///     <see cref = "BindAppTheme{TValue, TThemedKey}" />
    /// </summary>
    /// <typeparam name = "TThemedKey" > </typeparam>
    /// <param name = "bindable" > </param>
    /// <param name = "property" > </param>
