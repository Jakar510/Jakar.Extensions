...
public static class UserPreferences
{
    ...
    public static string GetKey( this object item, string caller, string propertyName ) => item.GetType()
                                                                                               .GetKey( caller, propertyName );
    public static string GetKey( this Type type, string caller, string propertyName ) => $"{type.FullName}.{caller}.{propertyName}";

    public static string GetKey( this object item, [CallerMemberName] string propertyName = "" ) => item.GetType()
                                                                                                        .GetKey( propertyName );
