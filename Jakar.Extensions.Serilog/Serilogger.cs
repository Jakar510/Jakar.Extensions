    ...
    where TApp : IAppID
{
    ...
    public bool                                 BlockWhenFull                   { get; init; } = true;
    ...
    public Logger                               Logger                          => _logger ??= GetLogger();
    ...
    protected virtual Logger GetLogger()
    {
        ...
        builder.WriteTo.Seq( "http://localhost:5341/ingest/otlp/v1/logs" );

        // builder.WriteTo.OpenTelemetry();
